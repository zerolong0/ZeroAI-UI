...
:root {
  ...
  --ai-surface-elevated: rgba(255, 255, 255, 0.9);

  /* Border - 半透明边框 */
  --ai-border: rgba(102, 126, 234, 0.3);
  --ai-border-strong: rgba(102, 126, 234, 0.5);

  /* Glow - 光晕效果（AI 标志性特征）*/
  --ai-glow: rgba(102, 126, 234, 0.5);
  --ai-glow-strong: rgba(102, 126, 234, 0.8);
}
```
...
```css
:root {
  /* Hybrid Gradient - 混合渐变 */
  --collab-gradient: linear-gradient(
    135deg,
    #2563EB 0%,      /* Human Blue */
    #667eea 50%,     /* Transition */
    #764ba2 100%     /* AI Purple */
  );
