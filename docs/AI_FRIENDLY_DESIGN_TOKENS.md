...
```css
:root {
  /* Primary - Taobao Orange（AI 核心颜色）*/
  --ai-primary: #FF6600;        /* Taobao Orange-6 */
  --ai-primary-light: #FF7A1F;  /* Orange-5 (悬停) */
  --ai-primary-dark: #E55A00;   /* Orange-7 (按下) */
...
**颜色选择理由**：
- 🎨 介于 Human Gray (#737373) 和 AI Orange (#FF6600) 之间
- 🤝 视觉上传达"融合"概念
- 📊 纯色设计，符合 v5.1.0+ 原则
